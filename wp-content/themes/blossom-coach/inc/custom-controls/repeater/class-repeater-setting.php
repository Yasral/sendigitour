<?php
/**
 * Blossom Coach Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Blossom_Coach_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Blossom_Coach_Repeater_Setting extends WP_Customize_Setting {
